...
function mini_ajax(ajax_type,ajax_url,ajax_data,callback=function(){},m_async=true,process_data)
{
	$.ajax({
		type: ajax_type,
		url: ajax_url,
...
function loadPreviewImage(img, previewName){  
	console.log("loadPreviewImage",img);
	console.log("loadPreviewImage2",previewName);
